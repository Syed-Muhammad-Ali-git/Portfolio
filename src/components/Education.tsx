import { GraduationCap, Calendar, MapPin, Book, Award } from "lucide-react";
          ...
          <div className="relative">
            ...
            {educationData.map((edu, index) => (
              ...
              >
                {/* Timeline dot */}
                <div
                  className={`relative z-10 w-16 h-16 rounded-full flex items-center justify-center bg-${edu.color}/20 border-2 border-${edu.color} shadow-glow`}
                >
